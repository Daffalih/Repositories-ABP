...
<body>
    <div class="container">
        ...
        <?php if(session('error')): ?>
            <p class="msg"><?php echo e(session('error')); ?></p>
        <?php endif; ?>
...
</html><?php /**PATH C:\Users\ASUS\Documents\Repositories ABP\Pertemuan 5\Tugas 5 Web Framework 2\Tugas5WebFramework\resources\views/login.blade.php ENDPATH**/ ?>