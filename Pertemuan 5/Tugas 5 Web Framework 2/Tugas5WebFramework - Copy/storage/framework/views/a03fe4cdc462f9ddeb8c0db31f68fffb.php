...
<body>
    <div class="container">
        ...
        <?php if(session('success')): ?>
            <p class="msg"><?php echo e(session('success')); ?></p>
        <?php endif; ?>
...
</html><?php /**PATH C:\Users\ASUS\Documents\Repositories ABP\Pertemuan 5\Tugas 5 Web Framework 2\Tugas5WebFramework\resources\views/registration.blade.php ENDPATH**/ ?>